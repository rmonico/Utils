...
public class TextGridColumnAlignmentTests {
	...
	public void doLeftAlignmentTest() {
		...
		assertEquals("Left alignment", "abcdef    ", alignedValue);
	}
	...
	public void doLeftAlignmentTest3() {
		...
		assertEquals("Left alignment", "ab...", alignedValue);
	}
	...
	public void doLeftAlignmentTest4() {
		...
		assertEquals("Left alignment", "...", alignedValue);
	}
	...
	public void doRightAlignmentTest() {
		...
		assertEquals("Right alignment", "    abcdef", alignedValue);
	}
	...
	public void doRightAlignmentTest3() {
		...
		assertEquals("Right alignment", "...ef", alignedValue);
	}
	...
	public void doRightAlignmentTest4() {
		...
		assertEquals("Right alignment", "...", alignedValue);
	}
	...
	public void doCenterAlignmentTest() {
		...
		assertEquals("Center alignment", "  abcdef   ", alignedValue);
	}
	...
	public void doCenterAlignmentTest3() {
		...
		assertEquals("Center alignment", "ab...", alignedValue);
	}
	...
	public void doCenterAlignmentTest4() {
		...
		assertEquals("Center alignment", "...", alignedValue);
	}
}
